...
exports.checkoutMail = exports.exitMail = exports.welcomeMail = void 0;
...
const checkoutMail = (siteName, complain, itemsData, stripe, receipt) => {
    return `
  ...
  <div style="font-family: Arial, Helvetica, sans-serif; line-height: 2pc; position: relative;">
    ...
    <ul style="margin: 0; padding: 1pc 1pc 1pc 3pc; font-family: inherit; color: #727272;">
      ...
      ${itemsData.map((item) => `<li>${item.name}</li>`).reduce((tot, si) => tot + si)}
...
exports.checkoutMail = checkoutMail;
